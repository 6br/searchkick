  ...
  module Model
    def searchkick(**options)
      ...
      unknown_keywords = options.keys - [:_all, :_type, :batch_size, :callbacks, :conversions, :default_fields,
        ...
        :locations, :mappings, :match, :merge_mappings, :merge_settings, :routing, :searchable, :settings, :similarity,
        :special_characters, :stem_conversions, :suggest, :synonyms, :text_end, :merge_filters,
